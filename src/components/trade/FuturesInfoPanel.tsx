                  ...
                  {editing === o.orderId ? (
                    <div className="flex items-center gap-1.5">
                      ...
                      <input
                        ...
                        className="w-24 bg-bg-tertiary border border-border-default rounded-sm px-1.5 py-0.5 text-xs text-text-primary focus:outline-none focus:border-gold [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                        autoFocus
                      />
                      <button
