...
const PATHS = {
  ...
  /**
   * TradingView 官方标记（原始 viewBox 就是 24，与本图标集同尺寸，未改形）。
   *
   * 本集其余图标是描边线条，品牌标记是实心图形——fill/stroke 在 path 上单独
   * 覆盖，跟 grip / dots 那两个同样的写法。只用在「跳去 TradingView」这一个
   * 按钮上：手机上按钮只剩图标，通用外链箭头看不出要去哪，这个记号看得出。
   *
   * 形状是横宽竖窄的（占满 24 宽，只占中间 12 高），所以用比常规图标大一号的
   * 尺寸类，视觉重量才跟旁边的字对得上。
   */
  tradingview: (
    <>
      <path
        d="M15.8654 8.2789c0 1.3541-1.0978 2.4519-2.452 2.4519-1.354 0-2.4519-1.0978-2.4519-2.452 0-1.354 1.0978-2.4518 2.452-2.4518 1.3541 0 2.4519 1.0977 2.4519 2.4519z"
        fill="currentColor"
        stroke="none"
      />
      <path d="M9.75 6H0v4.9038h4.8462v7.2692H9.75Z" fill="currentColor" stroke="none" />
      <path d="M18.3462 6H24l-5.1058 12.173h-5.6538z" fill="currentColor" stroke="none" />
    </>
  ),
