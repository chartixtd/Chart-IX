...
import { getFuturesPositions, closePosition, getFuturesBalance, setLeverage, setMarginType } from "@/lib/bingx/futures";
...
export async function POST(request: NextRequest) {
  try {
    ...
    const { action, symbol, positionSide, leverage, marginType } = await request.json();
