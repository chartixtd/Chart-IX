...
export function FuturesWalletSummary() {
  ...
  return (
    <div className="border-t border-gold/20 px-3 py-2.5">
      <span className="text-[11px] font-medium uppercase tracking-wide text-text-muted">{t("futures_wallet")}</span>
      {balance ? (
        <div className="mt-1.5 flex items-baseline justify-between">
          <div>
            <div className="text-[11px] text-text-muted">{t("equity")}</div>
          ...
          <div className="text-right">
            <div className="text-[11px] text-text-muted">{t("available_margin")}</div>
            <div className="font-mono text-sm font-medium tabular-nums text-text-primary">
